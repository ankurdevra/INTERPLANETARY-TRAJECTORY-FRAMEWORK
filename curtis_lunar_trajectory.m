...
frame at time ti
rx_ - probe’s inertial position vector in moonfixed coordinates at time ti (km)
rmx_ - Moon’s inertial position vector in moonfixed coordinates at time ti (km)
...
[RA, Dec] = RA_DEC_from_geocentric_equatiorial_position_vector(rm0_);
distance = norm(rm0_);
hmoon_ = cross(rm0_,vm0);
hmoon = norm(hmoon_);
