function [Angular_momentum,Inclination,Eccentricity,RAAN,Argument_of_Perigee,True_anomaly,Radial_velocity,Time_period_of_orbit_hrs,Radius_perigee,Radius_apogee,Semimajor_axis,Semilatus_rectum,Eccentric_anomaly,Mean_anomaly,Orbits_in_a_day] = Orbital_elements_from_State_vectors(state_vector)
...
% REQUIRED INPUTS:
% state_vector = [1x6] km and km/sec state vector of an body orbiting earth
% OUTPUTs:
